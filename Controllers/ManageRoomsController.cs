...
namespace TheRooms.Controllers
{
    public class ManageRoomsController : Controller
    {
        ...
        public ManageRoomsController(DataContext context)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Task,Answer")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Task,Answer")] Room room)
        {
            if (id != room.Id)
            {
                return NotFound();
